...
.tb-'.$uid.'[data-align=bottom] .tst-box-bqt:after { border-top-color: '. $color .' !important ; }
	...
	function element()
	{
		...
		?>
			...
			<div class="testimonial_box tst-box tb-<?php echo $uid; ?> clearfix <?php echo $cssClass;?> <?php echo $this->opt('css_class',''); ?>" data-align="<?php echo $align;?>" data-theme="<?php echo $style;?>">
				<div class="details tst-box-details">
					<?php
					if ( ! empty ( $options['tb_author_logo'] ) ) {
						$image = vt_resize( '', $options['tb_author_logo'], '60', '60', true );
						echo '<img class="tst-box-img" src="' . $image['url'] . '" width="' . $image['width'] . '" height="' . $image['height'] . '" alt="">';
					}
