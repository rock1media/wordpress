<?php
	...
	$sort_type = isset($zn_config['ptf_sortby_type']) && !empty($zn_config['ptf_sortby_type']) ? $zn_config['ptf_sortby_type'] : 'data';
	$sort_dir = isset($zn_config['ptf_sort_dir']) && !empty($zn_config['ptf_sort_dir']) ? $zn_config['ptf_sort_dir'] : 'asc';

?>
	<div class="hg-portfolio-sortable kl-ptfsortable portfolio-sort--<?php echo $portfolio_scheme; ?>">
	...
	<?php } ?>
		...
		?>
		<ul id="thumbs" class="ptf-stb-thumbs kl-ptfsortable-items fixclear" data-columns="<?php echo $numColumns;?>">
			<?php
