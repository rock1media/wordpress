...
<div class="zn_front_pb_wrap">
	...
	<div class="zn_pb_header clearfix">
		<div class="zn_fpb_buttons zn_left">
			<a class="zn_pb_icon zn_pb_close_panel zn_pb_icon" href="#"><span class="dashicons dashicons-arrow-down-alt2"></span></a>
			<a class="zn_pb_icon zn_pb_options_trigger zn_pb_icon" href="#" data-tooltip="Page options">
