...
/********************************************************/
	...
	$GLOBALS['csPluginVersion'] = '1.1.16';
...
function cuteslider_init($atts) {
	...
	wp_enqueue_script('cuteslider', $GLOBALS['csPluginPath'].'/js/cute.slider.js', array(), '1.1.16' );
	wp_enqueue_script('cuteslider_transitions', $GLOBALS['csPluginPath'].'/js/cute.transitions.all.js', array(), '1.1.16' );
	wp_enqueue_script('cuteslider_run', $GLOBALS['csPluginPath'].'/js/cute.run.js', array('cuteslider'), '1.1.16' );

	wp_enqueue_style('cuteslider', $GLOBALS['csPluginPath'].'/css/cuteslider.css', array(), '1.1.16' );
